...
<head>
    ...
    <link rel="shortcut icon" href="{{ asset('cv/assets/images/fav.jpg') }}">
    <link rel="stylesheet" href="{{ asset('cv/assets/css/bootstrap.min.css') }}">
    <link rel="stylesheet" href="{{ asset('cv/assets/css/fontawsom-all.min.css') }}">
    <link rel="stylesheet" type="text/css" href="{{ asset('cv/assets/css/style.css') }}"/>
</head>
            ...
            <div class="col-md-4 left-co">
                <div class="left-side">
                    <div class="profile-info">
                        <img src="{{ asset('cv/assets/images/profile.jpg') }}" alt="">
                ...
                <div class="rit-cover">
                    ...
                    <div class="about">
                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Duis accumsan purus enim, a
                            ...
                            elementum elementum nibh. Vivamus vitae eros malesuada, convallis dolor malesuada, lobortis
                            ex. Sed cursus augue risus, ac semper est consectetur vitae. Praesent consequat metus sit
                    ...
                    <div class="work-exp">
                        ...
                        <i>Microsoft / United States</i>
                        <ul>
                            <li><i class="far fa-hand-point-right"></i> Praesent consequat metus sit amet rhoncus
                                luctus.
...
<script src="{{ asset('cv/assets/js/jquery-3.2.1.min.js') }}"></script>
<script src="{{ asset('cv/assets/js/popper.min.js') }}"></script>
<script src="{{ asset('cv/assets/js/bootstrap.min.js') }}"></script>
<script src="{{ asset('cv/assets/js/script.js') }}"></script>
